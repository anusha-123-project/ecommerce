...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('home_assets/css/vendor.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('home_assets/style.css')}}">
  ...
  @forelse ($cart as $item)
    ...
    <li class="list-group-item d-flex justify-content-between lh-sm">
      <div>
        <h6 class="my-0">{{ $item['product_id'] }}</h6> {{-- Here is your PID --}}
        <small class="text-body-secondary">sdfsdfsd</small>
      </div>
      <span class="text-body-secondary">${{ $item['pquantity'] }}</span>
    </li>
  @empty
  ...
  .then(data => {
    console.log("Cart data:", data); // 👈 helpful debug log

    let ul = document.querySelector("#offcanvasCart .list-group");
    let badge = document.querySelector("#offcanvasCart .badge");
    let total = 0;

    if (!Array.isArray(data) || data.length === 0) {
      ul.innerHTML = `<li class="list-group-item">Cart is empty</li>`;
      badge.textContent = 0;
      return;
    }
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
            <div class="d-flex align-items-center my-3 my-sm-0">
              <a href="index.html">
                <img src="{{ asset('home_assets/images/logo.svg')}}" alt="logo" class="img-fluid">
              </a>
            </div>
          ...
          <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <!-- <a href="{{ url('Userregistration')}}" class="p-2 mx-1">
              ...
              <li>
                <!-- <a href="#" class="p-2 mx-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                  <svg width="24" height="24"><use xlink:href="#shopping-bag">1</use></svg>
                </a> -->
                <a href="#" class="position-relative p-2 mx-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
    ...
    <section style="background-image: url('{{ asset('home_assets/images/banner-1.jpg') }}'); background-repeat: no-repeat;background-size: cover;">
            ...
            <div class="category-carousel swiper">
              ...
              @foreach($categories as $cat)
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="{{ asset('storage/images/'.$cat->image) }}" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">{{$cat->title}}</h4>
                </a>
                @endforeach
              </div>
            ...
            @foreach($products as $product) 
                ...
                <div class="product-item">
                  <figure>
                    ...
                    @if ($product->images->isNotEmpty())
                      <img src="{{ asset('storage/product_images/' . $product->images->first()->image) }}" alt="Product Thumbnail" class="tab-image">
                      @endif
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
                        ...
                        <div class="col-7"><a href="#" class="btn btn-primary rounded-1 p-2 fs-7 btn-cart" data-id="{{ $product->id }}"><svg width="18" height="18"><use xlink:href="#cart"></use></svg> Add to Cart</a></div>
              ...
              <!-- <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-2.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
              ...
              <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-3.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
              ...
              <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-4.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
              ...
              <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-5.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
              ...
              <!-- <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-6.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
              ...
              <!-- <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-7.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
              ...
              <!-- <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-8.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
              ...
              <!-- <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-9.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
              ...
              <!-- <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-10.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
    ...
    style="background: url('{{ asset('home_assets/images/banner-ad-1.jpg') }}') no-repeat; background-size: cover;">
</div>
    ...
    style="background: url('{{ asset('home_assets/images/banner-ad-2.jpg') }}') no-repeat; background-size: cover;">
</div>
    ...
    style="background: url('{{ asset('home_assets/images/banner-ad-3.jpg') }}') no-repeat; background-size: cover;">
</div>
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-11.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-12.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-13.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-14.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-15.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                    <img src="{{ asset('home_assets/images/product-thumb-16.png') }}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-17.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
    ...
    style="background: url('{{ asset('home_assets/images/banner-newsletter.jpg') }}') no-repeat; background-size: cover;">
</div>
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-18.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Honeycrisp Apples</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-19.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-20.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-1.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Whole Wheat Sandwich Bread</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-21.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-22.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="{{ asset('home_assets/images/product-thumb-23.png')}}" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{ asset('home_assets/images/post-thumbnail-1.jpg')}}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{ asset('home_assets/images/post-thumbnail-2.jpg')}}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{ asset('home_assets/images/post-thumbnail-3.jpg')}}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-md-4">
                ...
                <div class="d-flex gap-2 flex-wrap mb-5">
                  <a href="#" title="App store"><img src="{{ asset('home_assets/images/img-app-store.png')}}" alt="app-store"></a>
                  <a href="#" title="Google Play"><img src="{{ asset('home_assets/images/img-google-play.png')}}" alt="google-play"></a>
                </div>
              </div>
              <div class="col-md-5">
                <img src="{{ asset('home_assets/images/banner-onlineapp.png')}}" alt="phone" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="{{ asset('home_assets/images/logo.svg')}}" width="240" height="70" alt="logo">
    ...
    <script src="{{ asset('home_assets/js/jquery-1.11.0.min.js')}}"></script>
...
$(document).ready(function() {
  ...
  $.ajax({
                  ...
                  success: function(data) {
                   console.log(data);
                  $('#cart-count').text(data.count); // Update badge count
                  }
    ...
    $('.btn-cart').on('click', function(e) {
        ...
        let q1 = "#quantity-"+productId;
        let qty = $(q1).val();
        
        // alert(qty);

        $.ajax({
            url: '{{ url('addtocart')}}', // We will define this route next
            method: 'POST',
            data: {
            ...
            success: function(response) {
                alert('working'); // Or show a nice toast or something
